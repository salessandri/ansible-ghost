...
## Role Variables
 ...
 - **`ghost__version`** (optional, default: _4.36.1_): ghost's docker image tag to use in the container. See [ghost image tags in dockerhub](https://hub.docker.com/_/ghost?tab=tags).
